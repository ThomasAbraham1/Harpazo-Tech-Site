...
const layerVariants = {
  ...
  visible: {
    scale: 1, 
    opacity: 1,
    transition: { duration: 0.8, ease: [0.04, 0, 0.2, 1] }
  }
};
...
export default function WebsiteServiceFlow() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[max-content_1fr] gap-12 lg:gap-4 items-center w-full max-w-7xl mx-auto ">
      ...
      <div className="max-w-md flex justify-center lg:justify-end md:order-1 order-2">
        <WebsiteAccordion />
      </div>
      ...
      <div className="flex w-full md:order-2 order-1 border-2 border-white/20 py-10 px-6 md:p-20 rounded-2xl justify-center items-center">
        <div className='grid grid-cols-8 justify-start items-center md:gap-6 gap-1 w-full'>
          ...
          >
            ...
            {/* Background Layer 1 */}
            <motion.div variants={layerVariants} className='absolute md:inset-x-4 inset-x-1.5 md:-inset-y-3.5 -inset-y-1.5 bg-slate-950 scale-1.5 border-1 border-white/20 rounded-2xl -z-20 pointer-events-none'>
            </motion.div>

            {/* Background Layer 2 */}
            <motion.div variants={layerVariants} className='absolute md:inset-x-7 inset-x-3.5 md:-inset-y-6.5 -inset-y-3 border-1 border-white/20 rounded-2xl -z-30 pointer-events-none'>
            </motion.div>
            ...
            >
              ...
              <div className='flex flex-row md:gap-3 gap-1 '>
                <div className="bg-gradient-to-r border-1 border-accent-orange/100 from-secondary-blue to-accent-orange rounded-lg">
                  <div className="text-[5px] md:text-xs tracking-widest md:px-2 md:py-1 px-1 py-1 text-center">Agency</div>
                </div>
                <div className="border-1 border-white/20 rounded-lg">
                  <div className="text-[5px] md:text-xs tracking-widest md:px-2 md:py-1 px-1 py-1">Store</div>
                </div>
                <div className=" border-1 border-white/20 rounded-lg">
                  <div className="text-[5px] md:text-xs tracking-widest md:px-2 md:py-1 px-1 py-1">Bakery</div>
                </div>
              </div>
          ...
          <div className='relative md:p-3 px-2 py-1 md:gap-4 gap-1 flex flex-row  col-span-3 self-end'>
            ...
            >
              <Text className='text-white text-center md:text-xs text-[4px] font-light tracking-widest p-[1px]'>
                <span className='text-accent-orange md:text-xl text-[8px] '> 3 </span> <br />
                Customer Reviews
              </Text>
              <Text className='text-white text-center md:text-xs text-[4px]   font-light tracking-widest p-[1px]'>
                <span className='text-accent-orange md:text-xl text-[8px]'> 90+ </span> <br />
                SEO mark
              </Text>
              <Text className='text-white text-center md:text-xs text-[4px] font-light tracking-widest p-[1px]'>
                <span className='text-accent-orange md:text-xl text-[8px]'> 100% </span> <br />
            ...
            >
              <div className="flex items-center md:gap-2 gap-1 md:p-1">
                <motion.div
                  ...
                  <Check className="md:w-3 md:h-3 w-2.5 h-2.5 text-accent-orange" />
                </motion.div>
                <Text className="text-white md:text-xs text-[6px] text-start m-0 leading-none">Approved</Text>
              </div>
              <Text className='text-white md:text-start md:text-xs text-end text-[6px] m-0 leading-none'>
