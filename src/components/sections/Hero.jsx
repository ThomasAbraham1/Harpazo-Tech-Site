...
const Hero = () => {
  return (
    <section className="relative min-h-[850px] lg:min-h-[950px] flex flex-col overflow-hidden pt-24 pb-0">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex-1 flex flex-col items-center">
        ...
        >
          ...
          <motion.div variants={fadeUp}>
            <Heading level={2} className="text-white text-5xl md:text-7xl mb-6 max-w-4xl leading-tight">
        ...
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full  flex flex-col items-center translate-y-5  mt-33 z-1">
          ...
          <motion.img
            ...
            className="absolute bottom-0 z-10 origin-bottom w-72 md:w-[450px] h-auto object-contain pointer-events-none drop-shadow-3xl"
          ...
          variants={fadeIn}
            ...
            className="relative  z-5 w-80 h-80 md:w-[450px] md:h-[400px] shrink-0 overflow-hidden rounded-xl bg-gradient-to-b from-secondary-blue from-[30%] to-[80%] to-accent-orange before:absolute before:-inset-px before:bg-gradient-to-t before:from-secondary-blue before:from-[40%] before:to-[110%] before:to-accent-orange before:[clip-path:polygon(100%_0%,100%_100%,0_100%)] after:absolute after:inset-0 after:bg-gradient-to-bl after:from-[70%] after:to-[90%] after:to-accent-orange "
          >
          </motion.div>
        </div>
           {/* Glow bottom center */}
